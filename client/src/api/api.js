...
api.interceptors.response.use(
    ...
    (error) => {
        ...
        if (error.response) {
            ...
            console.error(
                '[API Error Request] No response received:',
                error.request
            );
        } else {
            console.error(
...
export const getMovieBookingStats = async(
    movieId,
    timeframe
) => {
    const response = await api.get(
        `/movies/${movieId}/booking-stats`, {
            params: {
                timeframe,
            },
        }
...
export const addOrUpdateMyReview = async(
...
export const getSeatLayout = async(
    ...
    const response = await api.get(
        `/seats/screens/${screenId}/showtimes/${showtimeId}`
    );
...
export const getShowtimesByTheaterId = async(
    theaterId,
    queryParams = {}
) => {
    const response = await api.get(
        `/showtimes/theaters/${theaterId}`, {
            params: queryParams,
        }
    );
...
export const getShowtimeDetailsById = async(
    showtimeId
) => {
    const response = await api.get(
        `/showtimes/${showtimeId}/details`
    );
...
export const addMultipleShowtimes = async(
    bulkShowtimeData
) => {
    const response = await api.post(
        '/showtimes/multiple',
...
export const evaluateOfferApi = async({
    numTickets,
    subtotal,
    promoCode,
}) => {
...
export const likeTheater = async(theaterId) => {
    const response = await api.post(
        `/users/liked-theaters/${theaterId}`
    );
...
export const enableMovieNotification = async(
    movieId
) => {
    const response = await api.post(
        `/users/movie-notifications/${movieId}`
    );

    return response.data;
};

export const disableMovieNotification = async(
    movieId
) => {
    const response = await api.delete(
        `/users/movie-notifications/${movieId}`
