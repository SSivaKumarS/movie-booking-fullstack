          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 bg-[#0F0F17]/90 border border-gray-800/80 p-6 rounded-3xl backdrop-blur-2xl shadow-2xl">
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className="bg-emerald-950/80 hover:bg-emerald-900 border border-emerald-700/80 text-emerald-300 font-bold px-4 py-2.5 rounded-2xl transition text-xs flex items-center gap-2 shadow-lg cursor-pointer"
              >
                Export CSV Report
              </button>
              <button
                onClick={logoutAdmin}
                className="bg-red-950/80 hover:bg-red-900 border border-red-800/80 text-red-300 font-bold px-5 py-2.5 rounded-2xl transition text-xs shadow-lg cursor-pointer"
              >
                Exit Console
              </button>
            </div>
